...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntryA.drills'
        db.delete_column(u'api_entrya', 'drills_id')

        # Deleting field 'EntryA.sparring'
        db.delete_column(u'api_entrya', 'sparring_id')
    ...
    def backwards(self, orm):
        # Adding field 'EntryA.drills'
        db.add_column(u'api_entrya', 'drills',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.DrillEntryModule'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntryA.sparring'
        db.add_column(u'api_entrya', 'sparring',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.SparringEntryModule'], null=True, blank=True),
                      keep_default=False)
